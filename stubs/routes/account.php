...
Route::get('/account/name',
    [\App\Http\Controllers\Account\UpdateNameController::class, 'index'])->middleware('auth')->name('account.name');
...
Route::post('/account/email',
    [\App\Http\Controllers\Account\UpdateEmailController::class, 'store'])->middleware('auth');
...
Route::post('/account/password',
    [\App\Http\Controllers\Account\UpdatePasswordController::class, 'store'])->middleware('auth');
...
Route::post('/account/avatar',
    [\App\Http\Controllers\Account\UpdateAvatarController::class, 'store'])->middleware('auth');
